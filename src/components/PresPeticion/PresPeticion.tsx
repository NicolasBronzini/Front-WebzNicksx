...
import ImgEquipo from '../../assets/img/trabajo-en-equipo.jpg'; // @ts-ignore
      ...
      <div className="left-section">
        ...
        <div>
          <div className="ContainerCartMini">
            <span>
              <IoMdMegaphone className="IconCartMini" aria-label="Icono de comunicación efectiva" />
            </span>
          ...
          <div className="ContainerCartMini">
            <span>
              <BsFillGearFill className="IconCartMini" aria-label="Icono de compromiso con la calidad" />
            </span>
          ...
          <div className="ContainerCartMini">
            <span>
              <HiUserGroup className="IconCartMini" aria-label="Icono de seriedad y profesionalismo" />
            </span>
      ...
      <div className="right-section">
        <div className="image-wrapper">
          <div className="ContainerImg">
            <img src={ImgEquipo} alt="Imagen de trabajo en equipo" className="imgEquipo" />
          </div>
        </div>
      </div>
    </section>
